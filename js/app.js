...
function goodMorning(){
  ...
  if(question1.toLowerCase() === 'yes' || question1.toLowerCase() === 'y'){
    alert('that is great, you will have a great day!');
  }
  else if (question1.toLowerCase() === 'no' ||question1.toLowerCase() === 'n'){
    alert('That is ok because you are about to have a great day');
  }
...
function practiceCoding(){
  ...
  if(question2.toLowerCase() === 'yes' || question2.toLowerCase() === 'y'){
    alert('that is great, you are gonna be a pro someday!');
  }
  else if (question2.toLowerCase() === 'no' ||question2.toLowerCase() === 'n'){
    alert('That is ok keep practicing and do not forget to ask for help');
  }
  else alert('I dont know what that was, but hang in there and try y or n or yes or no');
}
